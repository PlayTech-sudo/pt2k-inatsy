...
if(isset($_POST['edit_cat'])){
  ...
  if(empty($errors)){
        $sql = "UPDATE excategory SET name='{$cat_name}'";
   ...
   <div class="col-md-5">
     <div class="panel panel-default">
       ...
       <div class="panel-body">
         <form method="post" action="edit_ecategory.php?id=<?php echo (int)$categorie['id'];?>">
           <div class="form-group">
               <input type="text" class="form-control" name="categorie-name" value="<?php echo remove_junk(ucfirst($categorie['name']));?>">
           </div>
           <button type="submit" name="edit_cat" class="btn btn-primary">Update ecategorie</button>
       </form>
       </div>
     </div>
   </div>
